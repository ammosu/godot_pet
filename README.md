...
美術用的是 [Codex Pets](https://codex-pets.net/) / petdex 格式的 sprite pack，
**這個 repo 裡不放任何美術，一張都沒有**。格式與工具是 MIT，但素材不是 —— 原創作品預設
CC BY-NC-SA，第三方角色的同人只允許個人非商業使用。從你自己安裝的位置讀取，授權關係就單純
留在你跟素材作者之間，不會因為經過這個 repo 而被重新散布。

同樣的理由，README 裡也不放跑起來的截圖。沒安裝任何 pack 的話，寵物會退回程式繪製的預設
造型，那個是這個專案自己畫的。
